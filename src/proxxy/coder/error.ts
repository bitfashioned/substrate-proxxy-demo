...
import type { RpcErrorInterface } from "@polkadot/rpc-provider/types";

import { isFunction } from "@polkadot/util";

const UNKNOWN = -99999;

function extend<Data, K extends keyof RpcError<Data>>(
  that: RpcError<Data>,
  name: K,
  value: RpcError<Data>[K]
): void {
 ...
 * ```
 */
export default class RpcError<T = never>
  extends Error
  implements RpcErrorInterface<T>
{
  public code!: number;
